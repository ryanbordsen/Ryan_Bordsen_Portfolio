...
**M.S. Management of Technology** – May 2027 **B.S. Mechanical Engineering (Aerospace Concentration)** – May 2026  
...
- Performed FEA, vibration, and fatigue analysis in ANSYS and MATLAB to assess performance.  
- Conducted dynamic balancing studies using accelerometers and FFT-based vibration analysis.  
...
- Conducted stress and strain analysis on piston pins and compared theoretical and experimental data.  

📄 [View Poster (PDF)](3d_printed_engine_poster.pdf)
...
- Correlated simulation, physical test data, and hand calculations to refine stiffness and failure resistance.  

📄 [View Poster (PDF)](truss_bridge_poster.pdf)
...
**Collaboration & Communication:** Microsoft Teams, Technical Writing
